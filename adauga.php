...
<input type="submit" value="ADAUGA" name="Modifica_cpu" style="height:50px; width:150px">
</form>
...
if(isset($_POST['Modifica_cpu']))
{
    if(count(array_filter($_POST))!=count($_POST)){
        ...
        $sql = "INSERT INTO `ProcesoareAMD` (`Producator`, `Serie`, `Numar`, `Performanta`) VALUES ('$Producator', '$Serie', '$Numar', '$Performanta')";
