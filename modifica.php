...
?>
    ...
    <?php
   $idd=$_GET['id'];
   $detalii=mysqli_query($dbC,"SELECT * FROM `ProcesoareAMD` WHERE `id`='$idd' ");
...
if(isset($_POST['Modifica_cpu']))
{
    if(count(array_filter($_POST))!=count($_POST)){
        ...
        $sql = "UPDATE `ProcesoareAMD` SET `Producator`='$Producator', `Serie`='$Serie', `Numar`='$Numar', `Performanta`='$Performanta' WHERE `id`='$idd' ";
